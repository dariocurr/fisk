...
public abstract class Stage {
    ...
    */
    ...
    /**
		Implementa l'operazione che il player ( reale o virtuale ) potrà effettuare in questa fase di gioco.
    	@param clickedTerritories territori coinvolti nell'operazione
    */
    public abstract void play(List<Territory> clickedTerritories);

    /**
		Rende cliccabili soltanto i bottoni leciti in questo stage.
		In questo modo l'utente è guidato nella scelta dei territori leciti
		e vengono implementate le regole del Risiko classico.
    */
