...
public abstract class Stage {
    ...
    /**
     * Implementa l'operazione che il player ( reale o virtuale ) potrà effettuare
    ...
    /**
     * Rende cliccabili soltanto i bottoni leciti in questo stage. In questo modo
     * l'utente è guidato nella scelta dei territori leciti e vengono implementate
