...
public abstract class AIPlayer extends Player {
    ...
    /**
		Costruttore che istanzia un player virtuale, con nome, colore e stile di gioco.
    ...
    */
    ...
    /**
		Restituisce il territorio in cui aggiungere l'armata.
		Questo metodo viene richiamato da Mediator durante la fase di rinforzo.
    ...
    */
    ...
    /**
		Restituisce la lista dei territori: da cui attaccare e da attaccare
		Questo metodo viene richiamato da Mediator durante la fase di attacco.
    ...
    */
    ...
    /**
		Restituisce i territorio coinvolti in  uno spostamento di armate.
		Questo metodo viene richiamato da Mediator durante la fase di spostamento.
    ...
    */
    ...
    /**
		Restituisce il numero di armate da spostare nei territori passati a parametro.
		Questo metodo viene richiamato da Mediator durante la fase di spostamento.
