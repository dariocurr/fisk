...
public abstract class RiskStrategy {
    ...
    /**
     * Dato il giocatore corrente, restituisce il territorio su cui posizionare
     * un' armata. Se il territorio con il minimo numero di armate è unico
     * allora verrà scelto come territorio su cui posizionare la prossima
     * armata; altrimenti verrà scelto il territorio più affine all'obiettivo da
     * raggiungere.
     *
     ...
     * coinvoti nell'attacco. Il primo territorio è il territorio da cui
     * attaccherà, il secondo sarà quello da attaccare. La scelta dei due
     * territori è basata sulla differenza di armate poste nel territorio
     * posseduto e nel territorio nemico. Se per una ed una sola certa coppia di
     * territori tale differenza è massima allora verrà scelta tale coppia,
     * altrimenti la scelta verrà effettuata in base all'affinità con
     ...
     * certa coppia di territori tale differenza è massima allora verrà scelta
     * tale coppia, altrimenti la scelta verrà effettuata in base all'affinità
     * con l'obiettivo da perseguire.
     *
     * @param player giocatore corrente
    ...
    /**
     * Dati i territori di partenza e di arrivo, restituisce il numero di armate
     * da spostare.
     *
     ...
     *
     * @param delta delta di armate tra territorio attacante e territorio
     * attacato
