...
/**
    Classe astratta che modella le funzionalità di Mediator.
    La classe implementa tutte le funzionalità che gestiranno il gioco.
    Il Mediator ha accesso alle risorse di gioco, preparerà il gioco,
    gestirà il turno e le fasi di gioco, e svolgerà tutte le attività 
    di servizio per il corretto funzionamento del gioco.
    La classe rappresenta metaforicamente un ipotetico arbitro o
    un ipotetico banco che gestisce il gioco.
*/
...
public abstract class RiskMediator extends Observable {
    ...
    */
    ...
    /**
        Restituisce il valore dell'attributo isEnded.
        isEnded assume valore true se uno dei giocatori ha raggiunto il proprio obiettivo, 
        ovvero se la partita è terminata, false altrimenti.
    ...
    */
    ...
    /**
        Inizializza il gioco creando il player reale, i player virtuali ed assegnando loro dei colori.
        Inoltre mischia i giocatori, rilascia gli obiettivi ai singoli giocatori, 
        distribuisce i territori, mette i tank iniziali e 
        chiama il metodo startPreparationStage per avviare la fase di preparazione.
        @param humanPlayerName nome scelto dal giocatore reale
        @param humanPlayerColor colore scelto dal giocatore reale
        @param virtualPlayersStrategies strategie scelte dall'utente per i giocatori virtuali
    */
    ...
    */
    ...
    /**
        Permette al player reale di effettuare le operazioni proprie della fase in cui si trova.
    ...
    */
    ...
    /**
        Rimuove il numero di armate specificate a parametro dal territorio specificato.
        @param territory territorio da cui rimuovere le armate
        @param num numero di armate da rimuovere
    ...
    */
    ...
    /**
        Gestisce ed esegue tutte le operazioni per implementare un attacco dal territorio from al territorio to.
