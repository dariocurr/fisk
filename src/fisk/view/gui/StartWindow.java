...
import fisk.strategy.AggressiveRiskStrategy;
import fisk.strategy.BalancedRiskStrategy;
import fisk.strategy.ConservativeRiskStrategy;
...
public class StartWindow extends JFrame {
    ...
    public StartWindow(RiskFacade facade) {
        ...
        this.addListeners();
        this.virtualPlayers = new TreeMap<>(
                (JLabel label1, JLabel label2) -> label1.getText().compareToIgnoreCase(label2.getText()));
    ...
    protected void addListeners() {
        ...
        this.startButton.addActionListener((ActionEvent ae) -> {
            ...
            dispose();
            facade.prepareGame(nameTextField.getText(), (RiskColor) playerColorList.getSelectedItem(),
                    virtualPlayersStrategies);
        });
