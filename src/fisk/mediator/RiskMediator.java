...
import fisk.game.ConcreteGameBuilder;
import fisk.game.Game;
import fisk.observer.Observable;
...
public abstract class RiskMediator extends Observable {
    ...
    /**
     * Restituisce il valore dell'attributo isEnded. isEnded assume valore true se
     * uno dei giocatori ha raggiunto il proprio obiettivo, ovvero se la partita è
     * terminata, false altrimenti.
     *
    ...
    /**
     * Inizializza il gioco creando il player reale, i player virtuali ed assegnando
     * loro dei colori. Inoltre mischia i giocatori, rilascia gli obiettivi ai
     * singoli giocatori, distribuisce i territori, mette i tank iniziali e chiama
     * il metodo startPreparationStage per avviare la fase di preparazione.
     *
     * @param humanPlayerName          nome scelto dal giocatore reale
     * @param humanPlayerColor         colore scelto dal giocatore reale
     * @param virtualPlayersStrategies strategie scelte dall'utente per i giocatori
     *                                 virtuali
     */
    public abstract void prepareGame(String humanPlayerName, RiskColor humanPlayerColor,
    ...
    /**
     * Permette al player reale di effettuare le operazioni proprie della fase in
     * cui si trova.
     *
     ...
     * @see fisk.AttackStage
     * @see fisk.ConcreteRiskMediator#handleAttack
     */
